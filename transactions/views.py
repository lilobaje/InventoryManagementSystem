...
class SupplierListView(ListView):
    model = Supplier
    template_name = "temp3/supplylist.html"
...
class SupplierCreateView(SuccessMessageMixin, CreateView):
    ...
    template_name = "temp3/createSupply.html"
...
class PurchaseView(ListView):
    model = PurchaseBill
    template_name = "temp3/purchaselist.html"
...
class SelectSupplierView(View):
    ...
    template_name = 'temp3/supplier.htm'
...
class PurchaseCreateView(View):                                                 
    template_name = 'temp3/new_purchase.html'
...
class SaleView(ListView):
    model = SaleBill
    template_name = "temp3/sale_list.htm"
    context_object_name = 'bills'
    ordering = ['-time']
    paginate_by = 10
...
class SaleCreateView(View):                                                      
    template_name = 'temp3/sales.html'
